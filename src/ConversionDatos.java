...
public class ConversionDatos {
    ...
    // Variable Privada: El nombre 'conversion_rate' debe coincidir EXACTAMENTE
    //    con el campo en el JSON de la API para que Gson lo reconozca.
    private double conversion_rate;

    // Constructor vacío para la inicialización por Gson
    public ConversionDatos() {
    }

    // Getter: Permite a la clase ConversorApp acceder al valor privado.
